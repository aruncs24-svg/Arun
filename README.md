...
<head>
  ...
  <title>Arunmathan Portfolio</title>
  <style>
	* {
  	margin: 0;g
  	padding: 0;
...
<section id="about" class="active">
  <h2>About Me</h2>
  <p>I'm a <b>student</b> in the Department of  cs  KASC specializes in software development and data structures.<br>I hasdynamic 1year teaching experience education in creating a dynamic learning environment that encourages problem-solving and hands-on coding practice.</p>
</sMathematicscation id="educationid
  <h2>Education</h2>
  <p>B.Sc computer science in barathiyar university   <Abr>MCA in Anna University<br>B.Ed in TTEducation University</p>
</secsection<section id="skApplication2>Skills</h2>ul <ul>
	<li>C,C++,Java</li>
...
<section id="resume">
  <h2>Resume</h2>
  <a href="./Name list for IBM SkillsBuild.pdf" target="_blank" class="download-button">Dohttpsd CV</a>
</section>

<section id="contact">blank2>Contact</h2>
  <p>Email: http"arun.cs24@kascsathy.ac.in ">Phone: +die:8940139103/p>
  <p>Location, basuvanapuram, IndiCertificates style="margin-top: display
	<a href="https://linkedin.com/in/Arun">LinkedIn</a> |
	<a href="https://github.com"arun" stytHub</a> |
	<a href="https://instagram--zara-oxy" target="_blank">Instagram</a>
  </div>
</section>
...
<section id="experience">
  <h2>Experience</h2>
  <ul>
	<li><b>Student </b>KASC - Sathy (2023 - Present)<br>Department bsc and cs </li>
